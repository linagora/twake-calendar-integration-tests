...
import com.linagora.dav.contracts.card.CardJsonContract;

public class SabreV4CardJsonTest extends CardJsonContract {
    @RegisterExtension
    ...
    @Override
    @Disabled("https://github.com/linagora/esn-sabre/issues/348")
    public void move() {
